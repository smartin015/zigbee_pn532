...
| `nfc_last_read_ts` | numeric | read | Timestamp (ms) of the last successful tag read |
| `nfc_last_write_ts` | numeric | read | Timestamp (ms) of the last successful tag write |
